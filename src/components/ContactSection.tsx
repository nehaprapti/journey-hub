...
const facultyContacts = [
  {
    title: "Dr. P. Shanmugaraja",
    detail: "Faculty Organiser",
    href: "tel:9944623405",
    color: "primary" as const,
  },
  {
    title: "Mr. R. Krishna Prakash",
    detail: "Faculty Organiser",
    href: "tel:9043215401",
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-6 mb-10">
            {facultyContacts.map((c, i) => {
              ...
              const formatted = phoneRaw.replace(/^(\d{5})(\d{5})$/, "$1 $2");
                    ...
                    <div>
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <div className={`text-sm mt-1 font-mono ${c.color === "primary" ? "text-primary" : "text-secondary"}`}>{c.detail}</div>
                        </div>
                      </div>
                    </div>
                    <hr className="border-t border-border/50 my-4" />
                    <div className="flex items-center gap-4">
                      <div className={`w-10 h-10 rounded-md flex items-center justify-center ${c.color === "primary" ? "bg-primary/10 text-primary" : "bg-secondary/10 text-secondary"}`}>
                        <Phone size={18} />
                      </div>
