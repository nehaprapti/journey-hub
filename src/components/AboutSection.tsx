        ...
        <ParallaxSection speed={0.2}>
          ...
          >
            ...
            <div className="order-3 md:order-3">
              ...
              <br></br>
              <span className="text-gradient-purple font-semibold">TECH ZEAL 2026</span> provides a platform for <span className="text-gradient-green font-semibold">Engineering, Arts & Science and Polytechnic college students </span>to come with an effective solution for problems that we face in our day to day life. 
